    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          >
            <h1 class="w-56 overflow-hidden whitespace-nowrap text-ellipsis">
              {{ item?.name }}
            </h1>
          </th>
          <td class="px-2 py-4">
          ...
          <td class="px-2 py-4 flex flex-row-reverse items-center gap-2">
            <button
              @click="deleteProductHistory(item?._id)"
              class="bg-gray-100 p-2 rounded text-red-400 active:scale-95 duration-300"
            >
              <IconTrash size="18" />
            </button>
            <button @click="viewDiscreption(item)" class="bg-gray-100 p-2 rounded active:scale-95 duration-300">
              <IconEye size="18" />
            </button>
          </td>
        </tr>
