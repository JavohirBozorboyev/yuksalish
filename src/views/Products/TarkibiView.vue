    ...
    >
      <form class="">
        ...
        >
          ...
          <option value="US">A mahsulot</option>
          <option value="CA">B mahsulot</option>
          <option value="FR">D mahsulot</option>
          <option value="DE">E mahsulot</option>
        </select>
      </form>
      ...
      >
        <RouterLink to="/productadd">+Qo'shish</RouterLink>
      </a>
